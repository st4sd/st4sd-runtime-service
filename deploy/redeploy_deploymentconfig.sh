...
# VV: Delete the `st4sd-runtime-service' pod
...
# We trigger re-deployment simply by deleting the pod of the `st4sd-runtime-service` DeploymentConfig,
# the associated replication controller will create a new one for us.
oc project ${PROJECT_NAME}
oc delete pod -ldeploymentconfig=st4sd-runtime-service
